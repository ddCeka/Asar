...
///
/// ```no_run
/// let file_entries = asar::list("myarchive.asar").expect("Something went wrong");
/// ```
...
///
/// ```no_run
/// match asar::pack("myfolder", "myarchive.asar") {
/// 	Ok(()) => println!("Success!"),
...
///
/// ```no_run
/// match asar::extract("myarchive.asar", "extracted") {
/// 	Ok(()) => println!("Success!"),
/// 	Err(err) => panic!("This should not have happened!")
/// }
/// ```
...
///
/// ```no_run
/// match asar::extract("myarchive.asar", "file.txt") {
/// 	Ok(()) => println!("Success!"),
/// 	Err(err) => panic!("This should not have happened!")
/// }
/// ```
